...
export const PRODUCT_SORT_OPTIONS = [
  { value: 'featured', label: 'Destacados' }, // Destacados
  { value: 'newest', label: 'Más recientes' }, // Más recientes
  { value: 'priceDesc', label: 'Precio: Mayor a Menor' }, // Precio: Mayor a Menor
  { value: 'priceAsc', label: 'Precio: Menor a Mayor' }, // Precio: Menor a Mayor
];
